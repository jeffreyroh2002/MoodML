...
saved_model_path = "../mood_classification/results/909_PCRNN_2D_binary_arousal_dataset_with_lyrics_3sec/saved_model"
test_data_path = "p4_8songs_3sec.json"
model_saved_mfcc = "../binary_classification/arousal_dataset_lyrics.json"
output_dir = "new_radar_results/new_radar_910p2_arousal"  # Directory to save individual radar chart images
...
# check number of segments for each song
