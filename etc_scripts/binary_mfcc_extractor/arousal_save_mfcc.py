...
JSON_FILE_NAME = "../../dataset_lyrics_extracted/background_arousal.json"
...
def map_to_binary_labels(semantic_label):
    if semantic_label in ["Bright", "Angry"]:
        return "high_arousal"
    elif semantic_label in ["Relaxed", "Melancholic"]:
        return "low_arousal"
    else:
...
def save_mfcc(dataset_path, json_path, n_mfcc=13, n_fft=2048, hop_length=512, num_segments=5):
    ...
    data = {
        "mapping": ["high_arousal", "low_arousal"],
        "mfcc": [],
        "labels": [],
    }
            ...
            for f in filenames:
                ...
                for s in range(num_segments):
                    ...
                    if len(mfcc) == expected_num_mfcc_vectors_per_segment:
                        ...
                        data["labels"].append(0 if binary_label == "high_arousal" else 1)
